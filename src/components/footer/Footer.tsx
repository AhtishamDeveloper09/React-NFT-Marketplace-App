...
function Footer() {
  return (
    <div className="py-10 px-[30px] md:px-10 lg:px-28 bg-[#3B3B3B]">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
          <div className="flex flex-col items-start gap-5">
            <img src={logo} alt="logo" />
            <p className="text-[#a2a2a2] text-base font-normal font-workSans">
              NFT marketplace UI created with Anima for Figma
            </p>
            <p className="text-[#a2a2a2] text-base font-normal font-workSans">
              Join our Community
            </p>
            <div className="flex gap-3 text-[#a2a2a2]">
              <FaYoutube size={25} />
              <FaDiscord size={25} />
              <FaLinkedin size={25} />
              <FaTwitter size={25} />
          ...
          <div className="flex flex-col items-start gap-5">
            ...
            <div className="hidden items-center lg:w-full w-fit md:flex bg-white rounded-[20px]">
              ...
              />
              <button className="px-8 py-3 bg-[#A259FF] rounded-[20px] text-white rounded-r-2xl font-workSans">
                Subscribe
              </button>
            </div>
            ...
            <input
              ...
              className="w-full block md:hidden px-5 py-4 border-0 rounded-[20px] font-workSans placeholder-[#2B2B2B]"
            />
            <button className="px-8 py-4 flex items-center justify-center gap-2 md:hidden bg-[#975DE7] rounded-[20px] text-white w-full rounded-r-2xl font-workSans">
        ...
        <div>
          ...
          <div className="mt-4 text-[#a2a2a2] text-left">
